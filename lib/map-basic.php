...
//split at '?' and replace with endpoint
$end_point = "https://betanyc.github.io/odw-basemap-widget/";
$url_parts = explode("?", $embed_url);
$url = $end_point . '?' .  $url_parts[1];
...
<iframe
  ...
  src="<?php echo esc_url( $url ); ?>" allowfullscreen>
</iframe>